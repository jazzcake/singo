...
JUICE_EXPORT juice_agent_t *juice_create_with_account(const juice_config_t *config, const char* ice_uflag, const char* ice_pwd) {
	if (!config)
		return NULL;

	return agent_create_with_account(config, ice_uflag, ice_pwd);
}
...
JUICE_EXPORT const char *juice_state_to_string(juice_state_t state) {
	...
	case JUICE_STATE_GATHERING:
		return "JUICE_STATE_GATHERING";
	case JUICE_STATE_CONNECTING:
		return "JUICE_STATE_CONNECTING";
	case JUICE_STATE_CONNECTED:
		return "JUICE_STATE_CONNECTED";
	case JUICE_STATE_COMPLETED:
		return "JUICE_STATE_COMPLETED";
